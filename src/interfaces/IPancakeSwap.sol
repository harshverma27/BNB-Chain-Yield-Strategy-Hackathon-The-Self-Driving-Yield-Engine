...
/// @title IPancakeSwap - Interfaces for PancakeSwap V2/V3 on BNB Chain
...
/// @notice PancakeSwap V2 Pair interface
...
/// @notice PancakeSwap MasterChef V3 interface for farm staking
